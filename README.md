...
npx @cryptoapis-io/mcp-address-history --transport http --host 0.0.0.0 --port 3000 --api-key YOUR_API_KEY \
...
npx @cryptoapis-io/mcp-address-history --transport http --host 0.0.0.0 --port 3000
```
