...
const RESOURCE_URI = "cryptoapis://address-history/supported-chains";

export function registerResources(server: McpServer): void {
    server.registerResource(
        "supported-chains",
        RESOURCE_URI,
        { description: "Supported blockchains, networks, and actions for address history queries and management" },
        (uri) => ({
            contents: [{
                uri: uri.href,
